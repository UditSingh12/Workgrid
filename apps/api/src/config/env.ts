...
const envSchema = z.object({
  ...
  DEMO_WORKSPACE_NAME: z.string().default("Workgrid Demo Workspace"),
  DEMO_OWNER_NAME: z.string().default("Demo Operator"),
  DEMO_OWNER_EMAIL: z.string().email().default("demo@workgrid.app"),
  DEMO_OWNER_PASSWORD: z.string().min(8).default("demo12345"),
